...
private let realtimeLog = OSLog(subsystem: "in.omprakashbharti.lazytype", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "in.omprakashbharti.lazytype.realtime.state")
