...
struct GeneralSettingsView: View {
    ...
    private var appBuildNumber: String {
        Bundle.main.object(forInfoDictionaryKey: "LazyTypeBuildTag") as? String
    ...
    private var outputLanguageSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("When set, LazyType translates your speech into the selected language.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
...
struct MicrophoneOptionRow: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .padding(12)
            .background(isSelected ? Color.brand.opacity(0.1) : Color(nsColor: .controlBackgroundColor))
            .cornerRadius(8)
            .overlay(
...
struct PromptsSettingsView: View {
    ...
    private var instructionGuardSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("When enabled, LazyType retries or falls back to the literal transcript if post-processing looks like it answered the dictated text instead of cleaning it.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
    ...
    private func runSystemPromptTest() {
        ...
        let context = AppContext(
            ...
            bundleIdentifier: "in.omprakashbharti.lazytype",
        ...
        HStack(spacing: 10) {
            Button {
                ...
                Image(systemName: isPlaying ? "stop.fill" : "play.fill")
                    ...
                    .background(Circle().fill(Color.brand.opacity(0.15)))
            }
            .buttonStyle(.plain)
