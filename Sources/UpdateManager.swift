...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/SamNickGammer/lazytype.omprakashbharti.in/releases?per_page=100")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["LazyTypeBuildTag"] as? String
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("lazytype-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("LazyType.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("lazytype-staged-\(UUID().uuidString)")
