<p align="center">
  <img src="Resources/AppIcon-Source.png" width="128" height="128" alt="LazyType icon">
</p>

<h1 align="center">LazyType</h1>
...
<p align="center">
  <a href="https://github.com/SamNickGammer/lazytype.omprakashbharti.in/releases/latest/download/LazyType.dmg"><b>⬇ Download LazyType.dmg</b></a><br>
...
<p align="center">
  <i>Built and maintained by <a href="https://github.com/SamNickGammer">SamNickGammer</a>.</i>
</p>

## Overview

LazyType is a free Mac dictation app that gives you fast AI transcription, context-aware cleanup, and voice-driven text editing without a monthly subscription. It is a free and open source alternative to [Wispr Flow](https://wisprflow.ai/), [Superwhisper](https://superwhisper.com/), and [Monologue](https://www.monologue.to/).

## Quick Start

1. Download the app from above or [click here](https://github.com/SamNickGammer/lazytype.omprakashbharti.in/releases/latest/download/LazyType.dmg)
...
- **Context-aware cleanup:** LazyType can read nearby app context so names, terms, and phrases are spelled correctly when you dictate into email, terminals, docs, and other apps.
- **Custom vocabulary:** Add names, jargon, and project-specific words that LazyType should preserve during cleanup.
...
There is no LazyType server, so LazyType does not store or retain your data. The only information that leaves your computer are API calls to your configured transcription and LLM provider.
...
<details>
  ...
  LazyType keeps the default network timeout at 20 seconds, but you can extend it with macOS defaults:

```bash
defaults write in.omprakashbharti.lazytype transcription_timeout_seconds -float 120
defaults write in.omprakashbharti.lazytype post_processing_timeout_seconds -float 120
defaults write in.omprakashbharti.lazytype context_request_timeout_seconds -float 120
```
...
```bash
defaults delete in.omprakashbharti.lazytype transcription_timeout_seconds
defaults delete in.omprakashbharti.lazytype post_processing_timeout_seconds
defaults delete in.omprakashbharti.lazytype context_request_timeout_seconds
```
